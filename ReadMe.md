...
- If your purpose is to build some HTMLs out of some Markdown documents, and you'd like to utilize my themes(thanks), then please consider this advise:
    ...
    > Although you can use CSS files in this package directly, as you following the guidelines below, I highly recommand you to checkout other two packages of mine, which are designed specifically for converting Markdowns into HTMLs. Both utilize CSS files generated by this package. And both are promoted right inside this article, [below](#promotions). With the helps of either of the promoted packages, you can convert your Markdown files with just tiny little efforts.
