...
The pictures below showcase how an article looks and feels as the default CSS generated by this tool is applied to the article.
...
const { // All 6 interfaces are here.
    ...
    // An object as a dictionary of provided files by this npm package.
